				...
				<div class="row">
					...
					<div class="col-xs-12 col-sm-6 col-md-6 col-lg-4">
						<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label getmdl-select getmdl-select__fix-height">
				            <input class="mdl-textfield__input" type="text" id="sexo_cliente" value="Seleccione sexo" readonly tabIndex="-1">
					...
					<div class="col-xs-12 col-sm-6 col-md-6 col-lg-4">
						<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label getmdl-select getmdl-select__fix-height">
				            <input class="mdl-textfield__input" type="text" id="region_cliente" value="Seleccione región" readonly tabIndex="-1" onchange="ListarComunas(this);">
					...
					<div class="col-xs-12 col-sm-6 col-md-6 col-lg-4">
						<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
							<input class="mdl-textfield__input" type="text" id="empresa_cliente">
